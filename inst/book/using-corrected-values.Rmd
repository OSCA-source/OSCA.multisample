...
To demonstrate, consider the two pancreas datasets from @grun2015denovo and @muraro2016singlecell.
...
This is most likely due to some difference in alignment stringency between the two studies, but the exact cause is irrelevant to this example.
