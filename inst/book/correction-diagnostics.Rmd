...
# Ranking clusters by the largest variances of log-abundances.
rv <- rowVars(norm)
...
tab <- table(paste("after", clusters.mnn[mnn.out$batch==1]),
...
tab <- table(paste("after", clusters.mnn[mnn.out$batch==2]),
