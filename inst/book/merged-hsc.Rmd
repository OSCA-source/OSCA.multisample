...
```{r, echo=FALSE}
stopifnot(igraph::are_adjacent(pseudo.out$mst, "4", "1"))
stopifnot(igraph::are_adjacent(pseudo.out$mst, "1", "2"))
stopifnot(igraph::are_adjacent(pseudo.out$mst, "2", "6"))
stopifnot(igraph::are_adjacent(pseudo.out$mst, "10", "5"))
...
```{r, echo=FALSE}
stopifnot(igraph::are_adjacent(pseudo.out2$mst, "4", "1"))
stopifnot(igraph::are_adjacent(pseudo.out2$mst, "1", "2"))
stopifnot(igraph::are_adjacent(pseudo.out2$mst, "2", "6"))
stopifnot(igraph::are_adjacent(pseudo.out2$mst, "5", "8"))
